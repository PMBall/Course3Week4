...
The following is the list of all the variables that are displayed:

* "Activity" - Activity being done during the measurement
* "Subject" - Subject number being measured
* "tBodyAcc-mean()-X"
* "tBodyAcc-mean()-Y"
* "tBodyAcc-mean()-Z"
* "tBodyAcc-std()-X"
...
The value displayed for each record is the average value of all the measurements for a distinct activity and subject.

The variables containing "meanFreq()" were not considered on purpose
...
- The table for point 5 is generated. It can be found in the working directory as "FinalDS.txt"